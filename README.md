...
кабинет бизнеса и кабинет команды.
...
не создаёт второе начисление. Лидерборд и достижения в текущий MVP не входят.
...
В итоговой интеграции прошли **116 pytest-тестов и 6 JavaScript-тестов**.
...
- Нет настоящих аккаунтов, лидерборда, платежей или промышленного развёртывания.
...
[Интеграция](docs/INTEGRATION.md) · [План развития](DEVELOPMENT_PLAN.md).
